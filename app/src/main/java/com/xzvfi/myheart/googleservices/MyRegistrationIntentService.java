...
import com.xzvfi.myheart.activity.RegisterActivity;
...
public class MyRegistrationIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        LocalBroadcastManager.getInstance(this)
                .sendBroadcast(new Intent(RegisterActivity.REGISTRATION_GENERATING));
        ...
        Intent registrationComplete = new Intent(RegisterActivity.REGISTRATION_COMPLETE);
